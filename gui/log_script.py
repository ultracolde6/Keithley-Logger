...
def main():
    ...
    # ion_gauge = kmm_data_handler.py.Channel(hard_port=110, chan_name='IonGauge', conv_func=lambda v: (v - 5) / 0.5)
    # ion_gauge_group = kmm_data_handler.py.SaveGroup([ion_gauge], group_name='IonGauge', quiet=True,
