...
class LogDisplay:
    def __init__(self, log_drive, name, final_date=False, start_date=False, load_days=7,
                 plot_days=1, resample=60, columns='voltage',
                 x_label='Time', y_label='', title='', track=True):
        self.directory = log_drive
        self.name = name
...
class VoltDisplay(LogDisplay):
    def __init__(self, log_drive, name, final_date=False, start_date=False, load_days=7,
        ...
        LogDisplay.__init__(self, log_drive, name, final_date, start_date, load_days,
...
class MagDisplay(LogDisplay):
    def __init__(self, log_drive, name, columns=('x', 'y', 'z'), background={'x': 0, 'y': 0, 'z': 0},
